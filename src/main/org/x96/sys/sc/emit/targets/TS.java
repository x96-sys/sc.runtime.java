...
public class TS extends Emitter {
    ...
    public String visit(Hippocampus hippocampus, String indent) {
        ...
        // Determine TypeScript type based on signal content
        String type = determineTypeScriptType(hippocampus.signal().orElse(null));

        return String.format("%sconst %s: %s = %s;", indent, id, type, value);
    }

    private String determineTypeScriptType(Signal signal) {
        if (signal == null) {
